    ...
    <div className="bg-white rounded-lg p-4 w-full">
      ...
      <div>
        <ReactToPrint
          ...
          documentTitle={`Survivor Reports (${search})`}
          pageStyle={"Print"}
        ...
        <div ref={componentRef}>
          ...
          <div className="bg-yellow-300 rounded-lg p-4 shadow-md shadow-gray-300">
          ...
          {/* =====Table 2======= */}
          <h1 className="mt-10 mb-1 text-sm font-semibold">
            Tab 2. Incidents reported by type of violence{" "}
          </h1>
          <div className="bg-green-300 rounded-lg p-4 shadow-md shadow-gray-300">
            <table className="w-full border border-black bg-white">
              <thead>
                <tr>
                  <th className="border-r border-r-black" rowSpan={3}>
          ...
          <div className="bg-orange-300 rounded-lg p-4 shadow-md shadow-gray-300">
            <table className="w-full border border-black bg-white">
              <thead>
                <tr>
                  <th className="border-r border-r-black" rowSpan={3}>
          ...
          <div className="bg-blue-300 rounded-lg p-4 shadow-md shadow-gray-300">
            <table className="w-full border border-black bg-white">
              <thead>
                <tr>
                  <th className="border-r border-r-black" rowSpan={3}>
          ...
          <div className="bg-lime-300 rounded-lg p-4 shadow-md shadow-gray-300">
            <table className="w-full border border-black bg-white">
              <thead>
                <tr>
                  <th className="border-r border-r-black" rowSpan={3}>
          ...
          <div className="bg-slate-300 rounded-lg p-4 shadow-md shadow-gray-300">
            <table className="w-full border border-black bg-white">
              <thead>
                <tr>
                  <th className="border-r border-r-black" rowSpan={3}>
          ...
          <div className="bg-purple-300 rounded-lg p-4 shadow-md shadow-gray-300">
            <table className="w-full border border-black bg-white">
              <thead>
                <tr>
                  <th className="border-r border-r-black" rowSpan={3}>
          ...
          <div className="bg-red-300 rounded-lg p-4 shadow-md shadow-gray-300">
            <table className="w-full border border-black bg-white">
              <thead>
                <tr>
                  <th className="border-r border-r-black" rowSpan={3}>
          ...
          <div className="bg-indigo-300 rounded-lg p-4 shadow-md shadow-gray-300">
            <table className="w-full border border-black bg-white">
              <thead>
                <tr>
                  <th className="border-r border-r-black" rowSpan={3}>
          ...
          <div className="bg-emerald-300 rounded-lg p-4 shadow-md shadow-gray-300">
            <table className="w-full border border-black bg-white">
              <thead>
                <tr>
                  <th className="border-r border-r-black" rowSpan={3}>
